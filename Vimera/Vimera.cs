        ...
        */
        ...
        private void FileHashExportHashsBtn_Click(object sender, EventArgs e){
            try{
                ...
                PrintEngineList.Add(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(v_lang.VimeraReadLangs("FileHashPrintEngine", "fhpe_6").Trim())), Application.ProductName, Application.ProductVersion.Substring(0, 4)));
